...
class ReportListScreen extends StatefulWidget {
  ...
  ReportListScreen({Key key, @required this.reportViewModel}) : super(key: key);

  @override
  _ReportListScreenState createState() => _ReportListScreenState(reportViewModel: reportViewModel);
}

class _ReportListScreenState extends State<ReportListScreen> {
  _ReportListScreenState({@required this.reportViewModel});
